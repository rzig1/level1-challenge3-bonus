...
1. **Admin View**: Fill out the "Create Intervention" form and assign it to a technician
2. **Role Switch**: Use the toggle buttons at the top to switch between Admin and Technician modes
3. **Technician View**: (Defaulted to Technician ID: 1) View assigned tasks and use the "Next Status" button to progress through the lifecycle
